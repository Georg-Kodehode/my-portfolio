...
import CVButton from "../components/skillsPageComponents/CVButton";
    ...
    <Wrapper>
      <SkillsPageWrapper>
        ...
        <Skill>
          ...
          <SkillList>
            Flask, jQuery, Bootstrap, Vue, React, Express.js
          </SkillList>
        </Skill>
        <Skill>
        ...
        <Skill>
          <SkillsCategory>Sertifikater:</SkillsCategory>
          <SkillList>B, T1, T4</SkillList>
        </Skill>
        <Skill>
